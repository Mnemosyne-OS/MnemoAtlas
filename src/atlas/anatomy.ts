...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'pregnancy',name:'Pregnancy reference',color:'#c9a6b4',description:'Placental and umbilical structures included in the female reference assembly. They describe a pregnancy and are hidden unless you ask for them.'},
