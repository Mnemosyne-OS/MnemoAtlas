...
// forwardRef, and only here: page.tsx passes `ref` to SheetTitle so the detail
// sheet can move focus to the structure name when it opens. React 19 carries a
// ref through a props spread; React 18 strips it before the component sees it,
// so without this the ref stays null and the sheet opens with focus nowhere —
// silently, and only for keyboard and screen-reader users.
